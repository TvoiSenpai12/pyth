...
PRIVATE_PUBLIC = 'pzxvb432cxvndjwecsjasd'  # скрытый паблик для управления ботом
PUBLIC_PUBLIC = 'mamoru_xui'  # паблик куда будем репостить
SOURCE_PUBLICS = [
...
PHONE_NUMBER = '+79281627307'  # номер зарегистрованный в телеге
 
 
# создаем клиент телеграм
app = Client("sasochki", api_id=API_ID, api_hash=API_HASH, phone_number=PHONE_NUMBER)
